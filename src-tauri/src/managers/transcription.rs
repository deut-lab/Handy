...
impl TranscriptionManager {
    ...
    pub fn transcribe(&self, audio: Vec<f32>) -> Result<String> {
        self.transcribe_inner(audio, true, "transcription")
    }

    pub fn transcribe_live_chunk(&self, audio: Vec<f32>) -> Result<String> {
        self.transcribe_inner(audio, false, "live chunk")
    }
